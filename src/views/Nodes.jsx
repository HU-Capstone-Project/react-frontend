  ...
  return (
    <div className="container-fluid p-5">
      ...
      <div className="row" style={{ marginTop: 20 }}>
        {!loading && nodes ? (
          nodes.map(({ name, time_received, start_pos_lat, start_pos_long, end_pos_lat,end_pos_long, id, key }) => {
            return (
                    ...
                    <div className="card-body">
                      <div className="row align-items-center no-gutters">
                        <div className="col mr-2">
                          <div
                            className={`text-info text-sm mb-1`}
                          >
                            <span className={`font-weight-bold`}>{"Surveyor: "}</span>
                            <span>{name}</span>
                          </div>
                          <div className="text-dark text-sm">
                            ...
                            <span>{(new Date(time_received)).toLocaleString('en-PK',)}</span>
                          </div>
                          <div className="text-dark text-sm">
                            <span className="font-weight-bold">
                              {"Start: "}
